              ...
              <div class="login_form ">
                <div class="login_div">
                  ...
                  <form id="login_form">
                    ...
                    <div class="mb-5">
                      ...
                      <div class="w-75 m-auto mt-3 d-none">
                  ...
                  <div c;ass="w-75 m-auto" style="display:none">
                ...
                <div class="otp_verify">
                  <form id="otp_verify_form">
                    ...
                    <div class="w-75 m-auto mt-5" style="display:none">
...
<script>
  ...
  $('#login_form').submit(function(e) {
    ...
    if (phone.length < mobile_no_len) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?= base_url('/web/Login_register/deleteSendOtp'); ?>',
        dataType: "json",
        data: {
          phone: phone,
        ...
        success: async function(data) {
          if (data.status == 1) {
            queueTrackingData('trackEvent', ['Login', 'SendOTP']);
    ...
    if (phone.length < mobile_no_len && email_id == '') {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if (data.status == 1) {
            queueTrackingData('trackEvent', ['Login', 'ResendOTP']);
  ...
  $('#otp_verify_form').submit(function(e) {
    ...
    if (otpLength < 6) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?= base_url('/web/Login_register/verifyDeleteSendOtp'); ?>',
        dataType: "json",
        data: {
          phone: phone,
          countryCode: countryCode,
        ...
        success: async function(data) {
          ...
          if (data.status == true) {
                  Swal.fire({
                    title: 'Alert !!',
                    text: "Are you sure want delete your account?",
                    ...
                    if (result.value) {
                      $.ajax({
                          type: 'POST',
                          url: '<?= base_url('/web/Login_register/buypassdelete'); ?>',
                          dataType: "json",
                          data: {},
                        success: function(res) {
                            localStorage.removeItem("pb_session");
                            removeCacheData('masterContent-'+(feedType??0), 'all');
                            //$('.otp_verify_form').remove();
