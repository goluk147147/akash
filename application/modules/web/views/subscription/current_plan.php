...
<?php
$activeChannels = [];
if($activePlan && isset($activePlan['data']['channels'])){
...
<section id="main-content">
            ...
            <div class="positionab_ ">
              ...
              <div class="container-fluid">
                ...
                <div class="row m-0">
                  <!--  <div class="col-md-12 p-0">
                            <div class="page-title d-flex align-items-center">
                                <div class="back-btn"> <a onclick="history.go(-1)"><i class="fa fa-chevron-left text-white" aria-hidden="true"></i></a></div>
                  ...
                  <div class="col-md-12 m-auto">
                    <div class="term-section">
                      ...
                      <div class="row">
                          ...
                          <div class="plan-dashobard p-lg-1 mb-4">
                            ...
                            <div class="d-flex justify-content-between">
                              ...
                              <div class="d-flex">
                                ...
                                <div><?= ' / ' . $activePlan['data']['detail']['pricing_title'] ?></div>
                              ...
                              <div class="row ">
                                ...
                                <div class="">
                                  ...
                                  <div class="d-flex align-items-center col-lg-12 plan_du_font">
                                    ...
                                    <span class="plan_basic_tt">
                                      <spa class="plan_dur f-500dur me-1"><?= $this->lang->line('duration') ?> :
                                    </span><?= date('jS F, Y', $activePlan['data']['detail']['purchase_date']) . ' - ' . date('jS F, Y', $activePlan['data']['detail']['expiry_date']) ?></span>
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <?php //pre(count($max_channels)); 
                        ?>
                        <? php // pre(count($max_channels));die; 
                        ?>
                        <div class="col-md-7 col-sm-12 p-3">
                          <div class="upgrad_maindiv p-lg-4 p-md-2 trem_sub_pad1">
                            <?php if (($max_channels > $subs_channel) && (!empty($activePlan['data']['channels'])) && (!empty($activePlan['data']['radio']))) { ?>
                              <div class="d-flex justify-content-end text-primary text-pri-color">
                                <span class="cursor-pointer" data-bs-target="#selectChannelRadio" data-bs-toggle="modal">+ <?= $this->lang->line('add_channel_radio') ?></span>
                              </div>
                            <?php } ?>
                            <div class="channelRadioUpgradMainDiv d-none">
                            ...
                            <div class="channelRadioUpgradMainDiv">
                                ...
                                <div class="m-q-y text-center">
                                  ...
                                  ?>
                                      ...
                                      <!-- <button class="<?php if ($i == 0) {
                                                            echo 'active';
                                                          } ?> plan_type" id="nav-year-tab" value="<?= str_replace(' ', '-', $pla['type']) ?>" type="button"><?= $pla['type'] ?></button> -->
                                  <?php
                                      if ($i == 0) {
                                        $typename = $pla['type'];
                                      }
                              ...
                              <div class="d-flex align-items-center justify-content-around">
                                <div class="w-100 mt-2">
                                  <!-- <div class="radio-buttons justify-content-between"> -->
                                  <!--  <div class="custom-radio">
                                                            <span class="radio-btn"><i class="fas fa-check"></i>
                                                                <div class="hobbies-icon"> 
                                                                    <div class="mb-0 h5"></div>

                                                                      <div class="h5 d-flex"></div>
                                                                      <div class="u-plan inactive" style="right: 10px;">
                                                                      Current Plan
                                                                    </div>
                                                                </div>
                                                            </span>
 ...
 -->
                                  ...
                                  <label class="custom-radio sing_pan w-100">
                                    <input type="radio" name="price-tab-plan isActive" checked>
                                    <span class="radio-btn" style="background:none"><i class="fas fa-check" style="background:var(--pbg);color: #fff;"></i>
                                      <div class="hobbies-icon">
                                        <div class="mb-0 h5 premium_ic"><?= $activePlan['data']['detail']['plan_name'] ?></div>
                                        <div class="h5 d-flex">₹ <?= ($activePlan['data']['detail']['plan_amount']) ?> <sub style="bottom: -12px;">&nbsp;/ <?= $activePlan['data']['detail']['pricing_title'] ?></sub></div>
                                  ...
                                  <div>
                                    ...
                                    if($publisherid != 0){
                                      $enc_publisherid = aes_cbc_encryption_($publisherid);
                                      $redirect_url = base_url('provider?id=').$enc_publisherid;
                                    }
                                    
                                    ?>
                                    <a href="<?= $redirect_url; ?>" class="btn w-50 ptp m-auto d-block mt-4" disabled><?= $this->lang->line('continue_watching') ?></a>
...
<script>
  ...
  $('#liveChannal').on('shown.bs.modal', function() {
    queueTrackingData('trackEvent', ['CurrentPlanDetail', 'View', 'LiveTVChannels']);
  });

  $('#radioChannal').on('shown.bs.modal', function() {
    queueTrackingData('trackEvent', ['CurrentPlanDetail', 'View', 'LiveRadioChannels']);
  });

  $('#selectChannelRadio').on('shown.bs.modal', function() {
    queueTrackingData('trackEvent', ['MyChannels', 'Select', 'AddMore']);
  ...
  function getChannel() {
    ...
    queueTrackingData('trackEvent', ['MyChannels', 'SelectChannel&Radio', 'Save']);
  ...
  <?php
    ...
    "View", 
    "CurrentPlanDetail(" . 
    $activePlan['data']['detail']['plan_name'] . "/" . 
    $activePlan['data']['detail']['pricing_title'] . "/" . 
    $activePlan['data']['detail']['amount'] . "/" . 
    $pur_date . "/" . 
    $exp_date . 
    ")"
    );
    ...
    var type = "<?=$type ?>";
    var string = "<?= $string ?>";
      queueTrackingData('trackEvent', [string]);
    })
</script>
