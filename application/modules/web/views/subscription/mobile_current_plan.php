                ...
                <div class="row m-0">
                  <div class="col-md-12 m-auto">
                    <div class="term-section">
                      ...
                      <div class="row">
                        <div class="col-md-12 col-lg-12 m-auto col-sm-12">
                          ...
                          <div class="plan-dashobard p-lg-1 mb-4">
                            ...
                            <div class="d-flex justify-content-between">
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                <div class="font-12s"><?= ' / ' . $activePlan['data']['detail']['pricing_title'] ?></div>
                            ...
                            <div class="channelRadioUpgradMainDiv">
                              <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="child-card">
                                  ...
                                  <div class="text_colr" data-bs-target="#liveChannal" data-bs-toggle="modal"><?= $this->lang->line('live_tv_channels') ?><i class="fas fa-chevron-right"></i></div>
                                </div>
                                <div class="child-card">
                                  <div class="imgchannel">
                                  ...
                                  <div class="text_colr" data-bs-target="#radioChannal" data-bs-toggle="modal"><?= $this->lang->line('live_radio_channels') ?><i class="fas fa-chevron-right"></i></div>
                                </div>
        ...
        <div class="col-md-12 col-sm-12 m-auto">
          <div class="main-container mt-3">
            <div class="my-4 d-f lex justify-content-center align-items-center">
              ...
              <div>
                                    <a href="<?= base_url() ?>" class="btn w-100 ptp mt-4" disabled><?= $this->lang->line('continue_watching') ?></a>
