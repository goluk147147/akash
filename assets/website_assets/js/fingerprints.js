...
var FingerprintJS = function (e) {
        ...
        return void 0 === o && (o = 16), t(this, void 0, void 0, (function () {
            ...
            return r(this, (function (r) {
                switch (r.label) {
                    ...
                    case 1:
                        return c < e.length ? (t[c] = n(e[c], c), (u = Date.now()) >= a + o ? (a = u, [4, i(0)]) : [3, 3]) : [3, 4];
                    case 2:
                        r.sent(), r.label = 3;
                    case 3:
                        return ++c, [3, 1];
    ...
    function p(e) {
        return e = h(e, [0, e[0] >>> 1]), e = h(e = m(e, [4283543511, 3981806797]), [0, e[0] >>> 1]), e = h(e = m(e, [3301882366, 444984403]), [0, e[0] >>> 1])
    }
    ...
    function b(e, n) {
        ...
        switch (c = [0, 0], u = [0, 0], r) {
            ...
            case 9:
                u = m(u = h(u, [0, e.charCodeAt(t + 8)]), s), i = h(i, u = m(u = f(u, 33), l));
            case 8:
            ...
            case 1:
                c = m(c = h(c, [0, e.charCodeAt(t)]), l), a = h(a, c = m(c = f(c, 31), s))
        }
        return a = d(a = h(a, [0, e.length]), i = h(i, [0, e.length])), i = d(i, a), a = d(a = p(a), i = p(i)), i = d(i, a), ("00000000" + (a[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (a[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (i[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (i[1] >>> 0).toString(16)).slice(-8)
    }
            ...
            function () {
                return t(e, void 0, void 0, (function () {
                    ...
                    return r(this, (function (n) {
                        switch (n.label) {
                            case 0:
                                return T(e = E()) ? N ? [2, o([], N, !0)] : G() ? [4, (t = document, (t.exitFullscreen || t.msExitFullscreen || t.mozCancelFullScreen || t.webkitExitFullscreen).call(t))] : [3, 2] : [3, 2];
                            case 1:
    ...
    function B(e) {
        ...
        return t(this, void 0, void 0, (function () {
            ...
            return r(this, (function (r) {
                switch (r.label) {
                    case 0:
                        for (t = document, o = t.createElement("div"), a = new Array(e.length), c = {}, _(o), s = 0; s < e.length; ++s) "DIALOG" === (u = A(e[s])).tagName && u.show(), _(l = t.createElement("div")), l.appendChild(u), o.appendChild(l), a[s] = u;
                        r.label = 1;
                    case 1:
    ...
    var te = {
        fonts: function () {
            return j((function (e, n) {
                ...
                r.appendChild(o);
                for (var s = 0; s < H.length; s++) a[H[s]] = u[s].offsetWidth, i[H[s]] = u[s].offsetHeight;
                return J.filter((function (e) {
                    return n = l[e], H.some((function (e, t) {
                ...
                return r(this, (function (r) {
                    switch (r.label) {
                        case 0:
                            ...
                            }, t = Object.keys(e), [4, B((i = []).concat.apply(i, t.map((function (n) {
                                return e[n]
                            }))))]) : [2, void 0];
                        case 1:
            ...
            return function (e, n) {
                ...
                return j((function (t, r) {
                    var a = r.document,
                        i = a.body,
                        c = i.style;
                    c.width = "".concat(n, "px"), c.webkitTextSizeAdjust = c.textSizeAdjust = "none", x() ? i.style.zoom = "".concat(1 / r.devicePixelRatio) : F() && (i.style.zoom = "reset");
                                    ...
                                    try {
                                        ...
                                        switch (c(r) && s(r), e.state) {
                                            case "running":
                                                ...
                                                break;
                                            case "suspended":
                                                document.hidden || d++, l && d >= n ? u(X("suspended")) : setTimeout(v, t)
                                        }
                                    } catch (o) {
                                        u(o)
                                    }
        ...
        languages: function () {
            ...
            if (void 0 !== r && t.push([r]), Array.isArray(n.languages)) x() && L([!("MediaSettingsRange" in (e = window)), "RTCEncodedAudioFrame" in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3 || t.push(n.languages);
        ...
        timezone: function () {
            ...
            var r, o = (r = (new Date).getFullYear(), -Math.max(g(new Date(r, 0, 1).getTimezoneOffset()), g(new Date(r, 6, 1).getTimezoneOffset())));
        ...
        canvas: function () {
            ...
            if (function (e, n) {
                ...
                var i = P(o);
                i !== P(o) ? e = n = "unstable" : (n = i, function (e, n) {
                    ...
                    return r(this, (function (r) {
                        switch (r.label) {
                            ...
                            case 1:
                                ...
                                }(c), (n || (null == i ? void 0 : i.debug)) && console.log("Copy the text below to get the debug data:\n\n```\nversion: ".concat(u.version, "\nuserAgent: ").concat(navigator.userAgent, "\ntimeBetweenLoadAndGet: ").concat(t - o, "\nvisitorId: ").concat(u.visitorId, "\ncomponents: ").concat(oe(c), "\n```")), [2, u]
                        }
                    }))
                }))
            }
    ...
    }, e.withIframe = j, Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});
