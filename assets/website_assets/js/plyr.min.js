                    ...
                    Ce(q(this.config.controls) ? this.config.controls : []).forEach((l) => {
                        ...
                        if (("captions" === l && c.appendChild(i.call(this, "captions", h)), "settings" === l && !W(this.config.settings))) {
                            ...
                            l.appendChild(o),
                                ...
                                c.append(Z("span", { class: `skip_intro`, id: `skip_intro` }));
                                c.append(Z("span", { class: `next_epsd`, id: `next_epsd` }));
                      ...
                      // c.append(document.createElement('p'),document.createElement('span'),document.createElement('div'));
                    ...
                    e(this, "media", () => {
                        ...
                        if (
                            ...
                            const i = he.call(e, `.${e.config.classNames.video}`);
                               ...
                               var append = i.appendChild(Z("div", { class: `appen_5s_seek`, id: `appen_5s_seek` }));
                               document.getElementById('appen_5s_seek').innerHTML += '<div class="video-rewind-notify rewind notification"><div class="rewind-icon icon"><i class="left-triangle triangle">◀◀◀</i><span class="rewind">5 seconds</span></div></div>  <div class="video-forward-notify forward notification"> <div class="forward-icon icon">       <i class="right-triangle triangle">▶▶▶</i><span class="forward">5 seconds</span></div></div>';
